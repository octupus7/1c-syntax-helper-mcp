...
**Назначение:** Возвращает детальную техническую информацию об элементе (синтаксис, параметры, доступность, примеры)
...
3. Извлекает полную информацию: синтаксис, параметры, возвращаемые значения, доступность, примеры
...
2. Извлекает только ключевую информацию: синтаксис, краткое описание и доступность
